...
The full implementation of the visual analytics dashboard is publicly available in the GitHub repository:
...
\begin{itemize}
    ...
    \item \texttt{data/} – The processed datasets (in JSON format) optimized for usage within the visualization platform.
\end{itemize}

To install and run the dashboard locally, please refer to the instructions provided in the \texttt{README.md} file of the repository.